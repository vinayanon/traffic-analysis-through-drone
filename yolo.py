...
ap.add_argument("-i", "--input",help="path to input video", default = "./test_video/2.mp4")
...
class YOLO(object):
	def __init__(self):
		...
		if args["class"] == 'tricycle'or args["class"] == 'awning-tricycle':
		   self.score = 0.15
		   self.iou = 0.15
		   self.model_image_size = (416, 416)		
		   
		if args["class"] == 'bicycle' or args["class"] == 'motor':
		   self.score = 0.1
		   self.iou = 0.1
		   self.model_image_size = (416, 416)
